...
const checkPaddleCollision = (ball, p1Y, p2Y) => {
...
export const updateBall = (ball, p1Y, p2Y) => {
...
export const updateScore = (state, scoringPlayer) => {
    if (scoringPlayer === 1) {
...
export const attachBallToPaddle = (state) => {
...
export const setServingPlayer = (state, scoringPlayer) => {
...
export const shouldEndGame = (state) => {
    return (state.p1Score >= GAME_CONSTANTS.WINNING_SCORE ||
